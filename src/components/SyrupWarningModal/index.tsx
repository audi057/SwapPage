...
import { Button, Text } from '@wdefifinancebsc/uikit'
    ...
    <Modal isOpen={isOpen} onDismiss={handleDismiss} maxHeight={90}>
      <WarningContainer className="token-warning-container">
        <AutoColumn gap="lg">
          <AutoRow gap="6px">
            <StyledWarningIcon />
            <Main color="failure">PASTA Warning</Main>
          </AutoRow>
          {transactionType !== '' && (
            <>
              <Body color="failure">
              ...
              <Body color="failure">
                {transactionType === 'Buying'
                  ? 'You will not receive KIWI rewards for holding purchased SYRUP.'
                  : 'You will need to buy back the same amount of SYRUP to be able to convert back to KIWI.'}
              </Body>
            </>
          )}
          <RowBetween>
